...
return {
  {
    "rktjmp/lush.nvim", -- dependency for creating colorschemes
    lazy = false,
  },
  {
    -- Custom colorscheme definition
    dir = vim.fn.stdpath("config") .. "/lua/themes/cursor-dark",
    name = "cursor-dark",
    lazy = false,
    priority = 1000,
    config = function()
      ...
      -- Dashboard / Alpha
      set_hl("DashboardHeader", { fg = colors.cyan })
      set_hl("DashboardFooter", { fg = colors.fgDark })
      set_hl("DashboardCenter", { fg = colors.fg })
      set_hl("DashboardShortCut", { fg = colors.yellow })
  ...
  -- Configure LazyVim to use cursor-dark
  {
    "LazyVim/LazyVim",
    opts = {
